...
#+HTML_HEAD: <link href="https://cdn.jsdelivr.net/npm/@exuanbo/file-icons-js@latest/dist/css/file-icons.min.css" rel="stylesheet">



NOTE #+OPTIONS: H:6 makes the exporter create outline-containers beyond the default 4 levels (this is needed for folding)

* Inclusion from another org file

#+INCLUDE: "./post0_nested.org"
...
<script src="foldable-headings.js"></script>
